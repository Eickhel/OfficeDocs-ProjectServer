...
If ($EntApps.Count -gt 0)
{
   ...
   Write-Host "Please check that you have 1 or more of the following subscriptions: Planner Plan 1, Project Plan 3 or Planner and Project Plan 5." -ForegroundColor Red
   $EntApps | ft -a 
}
else
{
